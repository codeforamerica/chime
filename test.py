...
class TestGoogleAuthorization(TestCase):
  ...
  # This doesn't work because assertRedirect prepends 'http://localhost' to the redirect_uri variable
  # I haven't figured a work around for testing this.
  # Mike is going to talk to the flask people.
    def test_authorization(self):
        app = self.create_app()
        redirect_uri = 'https://accounts.google.com/o/oauth2/auth?state=PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP&redirect_uri=http%3A%2F%2Fwww.example.com&response_type=code&client_id=client_id&approval_prompt=force&scope=openid+profile&access_type=offline'
